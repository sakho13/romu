...
type Props = {
  calenderState: ReturnType<typeof useCalender>
}

export function RomuCalender({ calenderState }: Props) {
  return (
      ...
      <div className='max-w-sm w-full shadow-lg'>
        <div className='md:p-8 p-5 dark:bg-gray-800 bg-white rounded-t'>
          <div className='px-4 flex items-center justify-between'>
            <span
              tabIndex={0}
              className='focus:outline-none select-none text-base font-bold dark:text-gray-100 text-gray-800'
            >
              {calenderState.currentMonth.year}/
              {calenderState.currentMonth.month}
            </span>

            <div className='flex items-center'>
              <button
                onClick={() => calenderState.calenderActions.prevMonth()}
              ...
              <button
                onClick={() => calenderState.calenderActions.nextMonth()}
